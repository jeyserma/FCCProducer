...
isr_alpha          = 0.0072993
isr_mass           = me
!epa_q_min = 5 # GeV ! default

?epa_recoil = true ! Flag to switch on recoil, i.e. a non-vanishing pT -kick for the equivalent-photon approximation (EPA)
?epa_keep_energy = true ! As the splitting kinematics for the EPA structure function violates Lorentz invariance when the recoil is switched on, this flag forces energy conservation when set to true, otherwise violating energy conservation.

cuts = all M > 5 GeV [ e1, E1 ]
