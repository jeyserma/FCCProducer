...
*<-i><----data-----><-------------------comments------------------------------>
 ...
 1500      0.00185e0 BESB1  =xpar( 1500) ! beam1 spread 0.132d-2
 1501      0.00185e0 BESB2  =xpar( 1501) ! beam2 spread  0.132d-2
 1502              0 BESRHO =xpar( 1501) ! correlation beam spread
    ...
    6         80.379 aMaW   =xpar( 6) ! W mass 
    7          2.085 GammW  =xpar( 7) ! W with, For gammW<0 it is RECALCULATED
